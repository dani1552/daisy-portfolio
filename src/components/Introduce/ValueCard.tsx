...
export default function ValueCard({ slug, title, description }: ValueCardProps) {
  ...
  return (
    <div
      onClick={handleClick}
      className="value-card group relative overflow-hidden rounded-lg border border-white/10 bg-white/5 p-2 sm:p-4 flex flex-col justify-between min-h-[85px] sm:min-h-[145px] text-left backdrop-blur-xl shadow-[0_8px_30px_rgba(0,0,0,0.25)] transition-all duration-500 hover:border-white/20 hover:shadow-[0_16px_45px_rgba(0,0,0,0.35)] cursor-pointer"
    >
